                  ...
                  let fields =
                    Bwd.map
                      (fun (Value.StructfieldAbwd.Entry
                        ...
                        | Term.CodatafieldAbwd.Found
                            ...
                            | Higher _ -> (
                                ...
                                | Found (Value.Structfield.Higher (lazy hd)) -> (
                                    ...
                                    | Neq ->
                                        fatal
                                          (Anomaly "comatch readback: field adjunction mismatch")
                                    | Eq ->
                                          ...
                                          Term.PlusPbijmap.build dim (Field.dim fld)
                                            {
                                              build =
                                                (fun pbij ->
                                                  ...
                                                  let ety =
                                                    tyof_field left (Ok dself.tm)
                                                      (Lazy.force dself.ty) fld newins in
                                                  let rtm =
                        ...
                        | _ -> fatal (Anomaly "comatch readback: field not found in codata type"))
                      comatch_fields in
