 ...
 fun deg ins ->
  ...
  | Suc (ins, g, i) -> (
      ...
      | Coresidual_zero deg ->
          ...
          (* This intrinsic generator is degenerated by the degeneracy, so it moves from the shared part to the remaining part, and hence has to pass all the shared generators that survive.  That is another consequence of the intrinsic dimensions being central. *)
          Deg_comp_ins
