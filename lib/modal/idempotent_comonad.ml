...
module Modality = struct
  ...
  type (_, _, _) t =
    ...
    | Comonad : (test_mode, comonad, test_mode) t
  ...
  type (_, _, _) comp =
    | Id_id_comp : (test_mode id_modality, test_mode id_modality, test_mode id_modality) comp
    | Id_comonad_comp : (test_mode id_modality, comonad, comonad) comp
    | Comonad_id_comp : (comonad, test_mode id_modality, comonad) comp
    | Comonad_comonad_comp : (comonad, comonad, comonad) comp
  ...
  let comp : type a m b n c. (b, n, c) t -> (a, m, b) t -> (a, n, m, c) composed =
   fun mu nu ->
    match (mu, nu) with
    | Id_modality, Id_modality -> Composed (Id_modality, Id_id_comp)
    | Id_modality, Comonad -> Composed (Comonad, Id_comonad_comp)
    | Comonad, Id_modality -> Composed (Comonad, Comonad_id_comp)
    | Comonad, Comonad -> Composed (Comonad, Comonad_comonad_comp)
  ...
  let comp_id_right : type a m b. (a, m, b) t -> (m, a id_modality, m) comp = function
    | Id_modality -> Id_id_comp
    | Comonad -> Comonad_id_comp

  let comp_id_left : type a m b. (a, m, b) t -> (b id_modality, m, m) comp = function
    | Id_modality -> Id_id_comp
    | Comonad -> Id_comonad_comp

  let comp_assocl : type m n mn p np mnp.
      (m, n, mn) comp -> (n, p, np) comp -> (m, np, mnp) comp -> (mn, p, mnp) comp =
   fun mn np m_np ->
    match (mn, np, m_np) with
    | Id_id_comp, Id_id_comp, Id_id_comp -> Id_id_comp
    | Id_comonad_comp, Comonad_id_comp, Id_comonad_comp -> Comonad_id_comp
    | Comonad_id_comp, Id_id_comp, Comonad_id_comp -> Comonad_id_comp
    | Comonad_comonad_comp, Comonad_id_comp, Comonad_comonad_comp -> Comonad_id_comp
    | Id_id_comp, Id_comonad_comp, Id_comonad_comp -> Id_comonad_comp
    | Id_comonad_comp, Comonad_comonad_comp, Id_comonad_comp -> Comonad_comonad_comp
    | Comonad_id_comp, Id_comonad_comp, Comonad_comonad_comp -> Comonad_comonad_comp
    | Comonad_comonad_comp, Comonad_comonad_comp, Comonad_comonad_comp -> Comonad_comonad_comp
  ...
  let comp_assocr : type m n mn p np mnp.
   ...
   fun mn np mn_p ->
    ...
    | Id_id_comp, Id_id_comp, Id_id_comp -> Id_id_comp
    | Id_comonad_comp, Comonad_id_comp, Comonad_id_comp -> Id_comonad_comp
    | Comonad_id_comp, Id_id_comp, Comonad_id_comp -> Comonad_id_comp
    | Comonad_comonad_comp, Comonad_id_comp, Comonad_id_comp -> Comonad_comonad_comp
    | Id_id_comp, Id_comonad_comp, Id_comonad_comp -> Id_comonad_comp
    | Id_comonad_comp, Comonad_comonad_comp, Comonad_comonad_comp -> Id_comonad_comp
    | Comonad_id_comp, Id_comonad_comp, Comonad_comonad_comp -> Comonad_comonad_comp
    | Comonad_comonad_comp, Comonad_comonad_comp, Comonad_comonad_comp -> Comonad_comonad_comp
  ...
  let factor : type a rn b n c. (a, rn, c) t -> (a, n, b) t -> (b, c, n, rn) factored option =
   fun mu nu ->
    match (mu, nu) with
    | Id_modality, Id_modality -> Some (Factored (Id_modality, Id_id_comp))
    | Comonad, Id_modality -> Some (Factored (Comonad, Comonad_id_comp))
    | Id_modality, Comonad -> None
    | Comonad, Comonad ->
        (* This is not unique, but we choose the id for maximum utility *)
        Some (Factored (Id_modality, Id_comonad_comp))
  ...
  let pushout : type a b c m n. (a, m, b) t -> (a, n, c) t -> (m, n, b, c) pushout =
   fun m n ->
    match (m, n) with
    | Id_modality, Id_modality -> Pushout (Id_modality, Id_modality, Id_id_comp, Id_id_comp)
    | Comonad, Id_modality -> Pushout (Id_modality, Comonad, Id_comonad_comp, Comonad_id_comp)
    | Id_modality, Comonad -> Pushout (Comonad, Id_modality, Comonad_id_comp, Id_comonad_comp)
    | Comonad, Comonad -> Pushout (Id_modality, Id_modality, Id_comonad_comp, Id_comonad_comp)
  ...
  let of_pre_dom : type a. pre -> a Mode.t -> a cod_wrapped option =
   fun x y ->
    ...
    | Comonad_pre, Test_mode -> Some (Wrap Comonad)
...
module Modalcell = struct
  ...
  type (_, _, _, _) t =
    | Id_id_cell : (test_mode, test_mode id_modality, test_mode id_modality, test_mode) t
    | Id_comonad_cell : (test_mode, comonad, comonad, test_mode) t
    | Counit_cell : (test_mode, comonad, test_mode id_modality, test_mode) t
  ...
  let find_unique : type a m b c n d.
   ...
   fun mu nu ->
    match (mu, nu) with
    | Id_modality, Id_modality -> Unique Id_id_cell
    | Comonad, Id_modality -> Unique Counit_cell
    | Id_modality, Comonad -> Nonunique
    | Comonad, Comonad -> Unique Id_comonad_cell

  let id : type dom modality cod.
      (dom, modality, cod) Modality.t -> (dom, modality, modality, cod) t = function
    | Id_modality -> Id_id_cell
    | Comonad -> Id_comonad_cell

  let id2 : type mode. mode Mode.t -> (mode, mode id_modality, mode id_modality, mode) t = function
    | Test_mode -> Id_id_cell
  ...
  let compare : type dom1 mu1 nu1 cod1 dom2 mu2 nu2 cod2.
   ...
   fun x y ->
    match (x, y) with
    | Id_id_cell, Id_id_cell -> Eq
    | Id_comonad_cell, Id_comonad_cell -> Eq
    | Counit_cell, Counit_cell -> Eq
    | _ -> Neq
  ...
  let compare_id : type dom mu nu cod.
    ...
    function
    | Id_id_cell -> Eq
    | Id_comonad_cell | Counit_cell -> Neq
  ...
  let hdom : type a m n b. (a, m, n, b) t -> a Mode.t = function
    | Id_id_cell -> Test_mode
    | Id_comonad_cell -> Test_mode
    | Counit_cell -> Test_mode
  ...
  let vdom : type a m n b. (a, m, n, b) t -> (a, m, b) Modality.t = function
    | Id_id_cell -> Id_modality
    | Id_comonad_cell -> Comonad
    | Counit_cell -> Comonad

  let vcod : type a m n b. (a, m, n, b) t -> (a, n, b) Modality.t = function
    | Id_id_cell -> Id_modality
    | Id_comonad_cell -> Comonad
    | Counit_cell -> Id_modality
  ...
  let hcomp : type a m n b r s c mr ns.
   ...
   fun mr ns x y ->
    match (x, y) with
    | Id_id_cell, Id_id_cell ->
        let Id_id_comp, Id_id_comp = (mr, ns) in
        Id_id_cell
    | Id_comonad_cell, Id_id_cell ->
        let Comonad_id_comp, Comonad_id_comp = (mr, ns) in
        Id_comonad_cell
    | Counit_cell, Id_id_cell ->
        let Comonad_id_comp, Id_id_comp = (mr, ns) in
        Counit_cell
    | Id_id_cell, Id_comonad_cell ->
        let Id_comonad_comp, Id_comonad_comp = (mr, ns) in
        Id_comonad_cell
    | Id_id_cell, Counit_cell ->
        let Id_comonad_comp, Id_id_comp = (mr, ns) in
        Counit_cell
    | Id_comonad_cell, Id_comonad_cell ->
        let Comonad_comonad_comp, Comonad_comonad_comp = (mr, ns) in
        Id_comonad_cell
    | Id_comonad_cell, Counit_cell ->
        let Comonad_comonad_comp, Comonad_id_comp = (mr, ns) in
        Id_comonad_cell
    | Counit_cell, Id_comonad_cell ->
        let Comonad_comonad_comp, Id_comonad_comp = (mr, ns) in
        Id_comonad_cell
    | Counit_cell, Counit_cell ->
        let Comonad_comonad_comp, Id_id_comp = (mr, ns) in
        Counit_cell
  ...
  let vcomp : type a m n r b. (a, n, r, b) t -> (a, m, n, b) t -> (a, m, r, b) t =
   fun x y ->
    match (x, y) with
    | Id_id_cell, Id_id_cell -> Id_id_cell
    | Id_comonad_cell, Id_comonad_cell -> Id_comonad_cell
    | Counit_cell, Id_comonad_cell -> Counit_cell
    | Id_id_cell, Counit_cell -> Counit_cell
  ...
  let vcomp_extending : type a m k kn b n s c.
   ...
   fun comp x y ->
    ...
    | Id_id_comp -> (
        match (x, y) with
        | Id_id_cell, Id_id_cell -> Wrap Id_id_cell
        | Id_id_cell, Counit_cell -> Wrap Counit_cell)
    | Id_comonad_comp -> (
        match (x, y) with
        | Id_comonad_cell, Id_comonad_cell -> Wrap Id_comonad_cell
        | Counit_cell, Id_comonad_cell -> Wrap Counit_cell)
    | Comonad_id_comp -> (
        match (x, y) with
        | Id_id_cell, Id_comonad_cell -> Wrap Id_comonad_cell)
    | Comonad_comonad_comp -> (
        match (x, y) with
        | Id_comonad_cell, Id_comonad_cell -> Wrap Id_comonad_cell
        | Counit_cell, Id_comonad_cell -> Wrap Counit_cell)
