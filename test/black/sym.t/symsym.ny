...
axiom a022 : Id (Id A) a002 a012 a020 a021
...
axiom a122 : Id (Id A) a102 a112 a120 a121

{` Front face `}
axiom a200 : Id A a000 a100
axiom a201 : Id A a001 a101
axiom a202 : Id (Id A) a002 a102 a200 a201

{` Back face `}
axiom a210 : Id A a010 a110
axiom a211 : Id A a011 a111
axiom a212 : Id (Id A) a012 a112 a210 a211

{` Left face `}
axiom a220 : Id (Id A) a020 a120 a200 a210

{` Right face `}
axiom a221 : Id (Id A) a021 a121 a201 a211

{` Center `}
axiom a222 : Id (Id (Id A)) a022 a122 a202 a212 a220 a221
...
def sym2 (x00 x01 : A) (x02 : Id A x00 x01) (x10 x11 : A)
  (x12 : Id A x10 x11) (x20 : Id A x00 x10) (x21 : Id A x01 x11)
  (x22 : Id (Id A) x02 x12 x20 x21)
  : Id (Id A) x20 x21 x02 x12
  ≔ sym x22
