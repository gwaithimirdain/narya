...
A comatch against a codatatype with a higher field is displayed by listing every field instance, each in the context degenerated by the partial bijection's remaining dimensions (here the declaration instance ".root.e").

  $ narya -e 'def N : Type ≔ data [ zero. | suc. (_ : N) ]' -e 'def √N : Type ≔ codata [ x .root.e : N ]' -e 'def r : √N ≔ [ .root.e ↦ 0 ]' -e 'about r'
  [ .root.e ↦ 0 ]
    : √N
