...
axiom x22 : Id ((x y ↦ Id X x y) : X → X → Type) x02 x12 x20 x21
axiom Y : Type
axiom y : Y
axiom s : Σ (Id ((x y ↦ Id X x y) : X → X → Type) x02 x12 x20 x21) (_ ↦ Y)

def s1s : Id ((x y ↦ Id X x y) : X → X → Type) x20 x21 x02 x12 ≔ sym (s .fst)
