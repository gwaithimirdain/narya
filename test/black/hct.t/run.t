  ...
  s22 .root.1
    : A⁽ᵉ⁾ (s20 .root) (s21 .root)
  
  sym s22 .root.1
    : A⁽ᵉ⁾ (s02 .root) (s12 .root)
  
  refl s2 .root.1
    : A⁽ᵉ⁾ (s2 .root) (s2 .root)
  
  s2⁽ᵉ¹⁾ .root.1
    : A⁽ᵉ⁾ (refl s0 .root) (refl s1 .root)
  
  refl s2 .root.1
    : A⁽ᵉ⁾ (s2 .root) (s2 .root)
  
  s0⁽ᵉᵉ⁾ .root.1
    : A⁽ᵉ⁾ (refl s0 .root) (refl s0 .root)
  ...
  refl f t20 t21 (sym t22)
    : A⁽ᵉ⁾ (f t00 t01 t02) (f t10 t11 t12)
  
  refl f t02 t12 t22
    : A⁽ᵉ⁾ (f t00 t10 t20) (f t01 t11 t21)
  ...
  refl f b2 b2 b2⁽ᵉ¹⁾
    : A⁽ᵉ⁾ (f b0 b0 (refl b0)) (f b1 b1 (refl b1))
  ...
  u2 .root
   ...
   ￮ hole ?0:
     ...
     ----------------------------------------------------------------------
     refl ID A⁽ᵉ⁾ (refl u0 .root) (refl u1 .root)
  ...
  u22 .root.1
    : ID⁽ᵉ⁾ A⁽ᵉ⁾ (u20 .root) (u21 .root)
  
  sym u22 .root.1
    : ID⁽ᵉ⁾ A⁽ᵉ⁾ (u02 .root) (u12 .root)
   ...
   ￮ hole ?3:
     ...
     ----------------------------------------------------------------------
     refl ID A⁽ᵉ⁾ (u20 .root) (u21 .root)
  
   ￫ info[I3003]
   ￮ hole ?4:
     
     ----------------------------------------------------------------------
     refl ID A⁽ᵉ⁾ (u02 .root) (u12 .root)
  ...
  s222 .rroot.12
    : A⁽ᵉ⁾ (s220 .rroot.12) (s221 .rroot.12)
  
  s222⁽¹³²⁾ .rroot.12
    : A⁽ᵉ⁾ (s202 .rroot.12) (s212 .rroot.12)
  
  s222⁽²³¹⁾ .rroot.12
    : A⁽ᵉ⁾ (s022 .rroot.12) (s122 .rroot.12)
  
  s222⁽²¹³⁾ .rroot.12
    : A⁽ᵉ⁾ (sym s220 .rroot.12) (sym s221 .rroot.12)
  
  s222⁽³²¹⁾ .rroot.12
    : A⁽ᵉ⁾ (sym s022 .rroot.12) (sym s122 .rroot.12)
  
  s222⁽³¹²⁾ .rroot.12
    : A⁽ᵉ⁾ (sym s202 .rroot.12) (sym s212 .rroot.12)
