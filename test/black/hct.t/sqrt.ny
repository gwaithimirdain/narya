...
def √f (b : B) : √A ≔ [ .root.e ↦ f b.0 b.1 b.2 ]
...
axiom t22 : Id (Id B) t02 t12 t20 t21

echo √f⁽ᵉᵉ⁾ t22 .root.2
echo √f⁽ᵉᵉ⁾ t22 .root.1
...
| .root.e ↦ refl f b2 b2 (sym (refl b2))
| .root.1 ↦ a]
...
def ID (X : Type) : Type ≔ sig ( x0 : X, x1 : X, x2 : Id X x0 x1 )

def √IDA : Type ≔ codata [ x .root.e : ID A ]

def η (a : A) : √IDA ≔ [ .root.e ↦ (a.0, a.1, a.2) ]
...
def u2' : Id √IDA u0 u1 ≔ [ .root.1 ↦ ? | .root.e ↦ ? ]
...
axiom u22 : Id (Id √IDA) u02 u12 u20 u21
echo u22 .root.1
echo u22 .root.2

def u22' : Id (Id √IDA) u02 u12 u20 u21 ≔ [
| .root.1 ↦ ?
| .root.2 ↦ ?
| .root.e ↦ ?]
