...
def √A : Type ≔ codata [ x .r.e : A ]

def √√A : Type ≔ codata [ x .rr.ee : A ]

def √_√A : Type ≔ codata [ x .r_r.e : √A ]

def f (x : √√A) : √_√A ≔ [ .r_r.e ↦ [ .r.e ↦ x.22 .rr.12 ] ]

def g (x : √_√A) : √√A ≔ [ .rr.ee ↦ x.22 .r_r.1 .r.1 ]
...
| .r_r.1 ↦ refl x .r_r.1
| .r_r.e ↦ [ .r.1 ↦ refl x.2 .r_r.1 .r.1 | .r.e ↦ refl (x.22 .r_r.1 .r.1) ]]
