...
def transport2 (A : Type) (B : A → Type) (x y : A) (p q : Id A x y)
  ...
  ≔ sym (B⁽ᵉᵉ⁾ r) (refl B p .liftr.1 b) (refl B q .liftr.1 b) .trr.1 (refl b)

{` Uniform higher operations on squares `}
def refl_transport_1 (A : Type) (B : A → Type) (x₀₀ x₀₁ : A)
  (x₀₂ : Id A x₀₀ x₀₁) (x₁₀ x₁₁ : A) (x₁₂ : Id A x₁₀ x₁₁)
  (x₂₀ : Id A x₀₀ x₁₀) (x₂₁ : Id A x₀₁ x₁₁) (x₂₂ : Id (Id A) x₀₂ x₁₂ x₂₀ x₂₁)
  (y₀ : B x₀₀) (y₁ : B x₀₁) (y₂ : Id B x₀₂ y₀ y₁)
...
def J (A : Type) (a : A) (P : (y : A) → Id A a y → Type) (pa : P a (refl a))
  (b : A) (p : Id A a b)
  : P b p
  ≔
...
def Jβ (A : Type) (a : A) (P : (y : A) → Id A a y → Type) (pa : P a (refl a))
  ...
  let s ≔ sq .liftr.1 (refl a) in
  let cube
    ≔ refl (Sq A) (refl a) (refl a) a⁽ᵉᵉ⁾ (refl a) (refl a) s a⁽ᵉᵉ⁾ a⁽ᵉᵉ⁾ in
