...
def is11_Id (A0 A1 : Type) (A2 : Id Type A0 A1) (B0 B1 : Type)
  ...
  (re2 : refl is11 A2 B2 R2 re0 re1) (a0 : A0) (a1 : A1) (b0 : B0) (b1 : B1)
  (r0 : R0 a0 b0) (r1 : R1 a1 b1)
  ...
  contrr ≔ a2 ↦
    ...
    let q0 : Id (R0 a0) p0 r0 r0' ≔ re0 .contrr a0 .contract (b0, r0) .snd in
    let q1 : Id (R1 a1) p1 r1 r1' ≔ re1 .contrr a1 .contract (b1, r1) .snd in
    (refl S p0 p1 q0 q1 .trl u,
     v2 ↦
       ...
       S⁽ᵉᵉ⁾ (sym (refl p0)) (sym (refl p1)) (sym (refl q0)) (sym (refl q1))
           {v2} {u} (sym w .fst, sym w .snd) (refl S p0 p1 q0 q1 .liftl u)
         .trl (refl u)),
  contrl ≔ b2 ↦
