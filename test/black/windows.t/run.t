...
Matching with the wrong window modality is an error:
  ...
  $ narya compose.ny -e "def fwd2 (X :▱○| AType) (u : ▱ (○ X)) : ▱○ X ≔ match u [ par. y ↦ match (y :▱○| _) [ circ. x ↦ parcirc. x ]]"
   ￫ error[E1701]
...
own (possibly nontrivial) modality as the window:
  ...
  $ narya preserve.ny -e "def zfwd3 : (x :○| ⊥) → ⊥' ≔ []"

  $ narya preserve-higher.ny

Refuting a modal variable requires a window modality:

  $ narya preserve.ny -e "def zfwd2 (u : ○ ⊥) : ⊥' ≔ match u [ circle. x ↦ match x [ ] ]"
   ￫ error[E1705]
   ￭ command-line exec string
...
mention their mutual companions:
  ...
  $ narya preserve.ny -e "def nbad (u : ○ ℕ) : ○ ℕ ≔ match u [ circle. w ↦ match (w :○| _) [ zero. ↦ u | suc. n ↦ u ] ]"
   ￫ error[E1707]
   ￭ command-line exec string
  ...
  $ narya preserve.ny -e "def rbad (u : ○ R) : ⊥' ≔ match u [ circle. w ↦ match (w :○| _) [ r. y ↦ rbad (circle. y) ] ]"
   ￫ error[E1707]
   ￭ command-line exec string
  ...
  $ narya preserve.ny -e "def xbad (u : ○ X) : ○ Y ≔ match u [ circle. w ↦ match (w :○| _) [ x. v ↦ circle. v ] ]"
   ￫ error[E1707]
   ￭ command-line exec string
...
let rec datatype is still non-recursive:
  ...
  $ narya preserve.ny -e "def LT : DomType ≔ let rec T : DomType ≔ data [ t. (_ : T) ] in T" -e "def lbad (u : ○ LT) : ○ LT ≔ match u [ circle. w ↦ match (w :○| _) [ t. y ↦ circle. y ] ]"
   ￫ error[E1707]
   ￭ command-line exec string
  ...
  $ narya -v preserve.ny -e "def LN : DomType ≔ let rec T : DomType ≔ data [ n. ] in T" -e "def lgood (u : ○ LN) : ○ LN ≔ match u [ circle. w ↦ match (w :○| _) [ n. ↦ circle. (n.) ] ]" 2>&1 | tail -4
...
a clean let-bound variable is fine:
  ...
  $ narya preserve.ny -e "def DD : DomType ≔ let Z ≔ ((DD → DD) : DomType) in data [ d. (_ : Z) ]" -e "def dbad (u : ○ DD) : ○ DD ≔ match u [ circle. w ↦ match (w :○| _) [ d. y ↦ u ] ]"
   ￫ error[E1707]
   ￭ command-line exec string
  ...
  $ narya -v preserve.ny -e "def DN : DomType ≔ let Z ≔ (ℕ : DomType) in data [ d. (_ : Z) ]" -e "def dgood (u : ○ DN) : ○ DN ≔ match u [ circle. w ↦ match (w :○| _) [ d. y ↦ u ] ]" 2>&1 | tail -4
...
recursively makes it permanent:
  ...
  $ narya preserve.ny -fake-interact "def H : DomType ≔ data [ h. (_ : ?) ] def hbad (u : ○ H) : ○ H ≔ match u [ circle. w ↦ match (w :○| _) [ h. y ↦ circle. (h. y) ] ]"
   ￫ info[I0000]
  ...
  $ narya preserve.ny -fake-interact "def H : DomType ≔ data [ h. (_ : ?) ] solve 0 ≔ ⊥ def hgood (u : ○ H) : ○ H ≔ match u [ circle. w ↦ match (w :○| _) [ h. y ↦ circle. (h. y) ] ]"
   ￫ info[I0000]
   ￮ constant H defined, containing 1 hole
  ...
  $ narya preserve.ny -fake-interact "def H : DomType ≔ data [ h. (_ : ?) ] solve 0 ≔ H def hbad (u : ○ H) : ○ H ≔ match u [ circle. w ↦ match (w :○| _) [ h. y ↦ circle. (h. y) ] ]"
   ￫ info[I0000]
   ￮ constant H defined, containing 1 hole
...
is recursive:
  ...
  $ narya preserve.ny -fake-interact "def K : DomType ≔ ? solve 0 ≔ data [ k. (_ : K) ] def kbad (u : ○ K) : ○ K ≔ match u [ circle. w ↦ match (w :○| _) [ k. y ↦ circle. (k. y) ] ]"
   ￫ info[I0000]
  ...
  $ narya preserve.ny -fake-interact "def L : DomType ≔ ? solve 0 ≔ data [ l. ] def lgood (u : ○ L) : ○ L ≔ match u [ circle. w ↦ match (w :○| _) [ l. ↦ circle. (l.) ] ]"
   ￫ info[I0000]
