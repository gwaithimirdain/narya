  ...
  $ narya -v -e 'def bool : Type ≔ data [ true. | false. ] def bool.not (x : bool) : bool ≔ match x [ true. ⤇ false. | false. ⤇ true.]'
   ￫ info[I0000]
   ￮ constant bool defined
  ...
  $ narya -v -e 'def bool : Type ≔ data [ true. | false. ] def bool.and (x y : bool) : bool ≔ match x, y [ true., true. ⤇ true. | true., false. ⤇ false. | false., true. ⤇ false. | false., false. ⤇ false.]'
   ￫ info[I0000]
   ￮ constant bool defined
  ...
  $ narya -v -e 'def ℕ : Type ≔ data [ zero. | suc. (_ : ℕ) ] def bar (y0 y1 : ℕ) (y2 : Id ℕ y0 y1) : Type ≔ match y2 [ zero. ↦ ℕ | suc. n ↦ bar n.0 n.1 n.2 ]'
   ￫ info[I0000]
   ￮ constant ℕ defined
  ...
  $ narya -v -e 'def ℕ : Type ≔ data [ zero. | suc. (_ : ℕ) ] def bar (x : ℕ) (y0 y1 : ℕ) (y2 : Id ℕ y0 y1) : Type ≔ match x, y2 [ zero., zero. ↦ ℕ | zero., suc. n ↦ bar x n.0 n.1 n.2 | suc. _, zero. ↦ ℕ | suc. _, suc. n ↦ bar x n.0 n.1 n.2 ]'
   ￫ info[I0000]
   ￮ constant ℕ defined
