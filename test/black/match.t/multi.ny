...
def suc_even_not_even (n : ℕ) (e : even n) (e1 : even (suc. n)) : ⊥
  ≔ match n, e, e1 [
| zero., even_zero., _ ↦ .
| suc. zero., _, _ ↦ .
...
def sum⊥ (A : Type) (a : sum A ⊥) : A ≔ match a [ inl. a ↦ a | inr. _ ↦ . ]

{` And we can omit the refutation case if at least one constructor is given `}
def sum⊥' (A : Type) (a : sum A ⊥) : A ≔ match a [ inl. a ↦ a ]
...
def sum⊥'' (A : Type) (a : sum A ⊥) : A ≔ match a return _ ↦ A [ inl. a ↦ a ]
