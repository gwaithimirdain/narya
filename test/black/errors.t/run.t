  ...
  $ narya -parametric errors.ny -e "echo a : Type"
   ￫ error[E0401]
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (refl f {a})"
   ￫ error[E0502]
   ￭ command-line exec string
   1 | echo (refl f {a})
  ...
  $ narya -parametric errors.ny -e "echo (refl f {a} {a})"
   ￫ error[E0502]
   ￭ command-line exec string
   1 | echo (refl f {a} {a})
     ^ not enough arguments for a higher-dimensional function application
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (refl f (refl a) a)"
   ￫ error[E0701]
   ￭ command-line exec string
  ...
  $ narya -parametric errors.ny -e "echo (Id A a)"
   ￫ error[E0503]
   ￭ command-line exec string
   1 | echo (Id A a)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ((x |-> x) : Id (A -> A) f f)"
   ￫ error[E0702]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (({x} {y} |-> x) : Id (A -> A) f f)"
   ￫ error[E0501]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (({x0} {x1} x2 x3 ↦ refl f x0 x1 x2) : Id (A -> A) f f)"
   ￫ error[E0700]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (refl (x |-> x))"
   ￫ error[E0400]
   ￭ command-line exec string
   1 | echo (refl (x |-> x))
  ...
  [1]
  $ narya -parametric errors.ny -e "echo refl"
   ￫ error[E0600]
   ￭ command-line exec string
   1 | echo refl
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (sym f)"
   ￫ error[E0601]
   ￭ command-line exec string
   1 | echo (sym f)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (sym a2)"
   ￫ error[E0601]
   ￭ command-line exec string
   1 | echo (sym a2)
     ^ insufficient dimension for argument of degeneracy 'sym':
  ...
  [1]
  $ narya -parametric errors.ny -e "echo g"
   ￫ error[E0300]
   ￭ command-line exec string
   1 | echo g
     ^ unbound variable: g
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (a : Id A)"
   ￫ error[E0401]
   ￭ command-line exec string
   1 | echo (a : Id A)
     ^ term synthesized type
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (a : Id (Id A) (refl a) (refl a))"
   ￫ error[E0401]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "def q := Id Type A (Id A)"
   ￫ error[E0401]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "f (x"
   ￫ error[E0200]
   ￭ command-line exec string
   1 | f (x
     ^ parse error
  ...
  $ narya -parametric errors.ny -e ".fst x"
   ￫ error[E0200]
   ￭ command-line exec string
   1 | .fst x
     ^ parse error
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (f (con.str. x))"
   ￫ error[E0100]
   ￭ command-line exec string
   1 | echo (f (con.str. x))
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (x |-> f 0.1.2 x)"
   ￫ error[E0205]
   ￭ command-line exec string
   1 | echo (x |-> f 0.1.2 x)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (let x.y ≔ z in w)"
   ￫ error[E0202]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (x.y ↦ z)"
   ￫ error[E0202]
   ￭ command-line exec string
   1 | echo (x.y ↦ z)
     ^ invalid local variable name: x.y
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (a x.y b ↦ z)"
   ￫ error[E0202]
   ￭ command-line exec string
   1 | echo (a x.y b ↦ z)
     ^ invalid local variable name: x.y
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (↦ z)"
   ￫ error[E0200]
   ￭ command-line exec string
   1 | echo (↦ z)
     ^ parse error
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (a ↦ ( fst ≔ a, fst ≔ a ))"
   ￫ error[E0904]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ( (x) ≔ a )"
   ￫ error[E0905]
   ￭ command-line exec string
   1 | echo ( (x) ≔ a )
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ([ _ ↦ a ])"
   ￫ error[E0400]
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ([ | | .head |-> 0 | .tail |-> f ])"
   ￫ error[E0200]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (( fst ≔ a ) : A)"
   ￫ error[E0900]
   ￭ command-line exec string
   1 | echo (( fst ≔ a ) : A)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (( fst ≔ a ) : ℕ)"
   ￫ error[E0900]
   ￭ command-line exec string
   1 | echo (( fst ≔ a ) : ℕ)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (s .third)"
   ￫ error[E0800]
   ￭ command-line exec string
   1 | echo (s .third)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (zero. : Σ A B)"
   ￫ error[E1000]
   ￭ command-line exec string
   1 | echo (zero. : Σ A B)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (two. : ℕ)"
   ￫ error[E1000]
   ￭ command-line exec string
   1 | echo (two. : ℕ)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ((zero. a) : ℕ)"
   ￫ error[E1001]
   ￭ command-line exec string
   1 | echo ((zero. a) : ℕ)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ((suc. ) : ℕ)"
   ￫ error[E1001]
   ￭ command-line exec string
   1 | echo ((suc. ) : ℕ)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ((ungel ≔ r2) : symr2ty)"
   ￫ error[E0901]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "echo (gg' .ungel)"
   ￫ error[E0800]
   ￭ command-line exec string
   1 | echo (gg' .ungel)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ((x ↦ x.0) : A -> A)"  
   ￫ error[E0506]
   ￭ command-line exec string
   1 | echo ((x ↦ x.0) : A -> A)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ((x ⤇ x) : A -> A)"
   ￫ error[E0508]
   ￭ command-line exec string
   1 | echo ((x ⤇ x) : A -> A)
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ((n0 n1 n2 ↦ match n2 [ zero. ↦ zero. | suc. n ↦ suc. n.2 ]) : (n0 n1 : ℕ) → Id ℕ n0 n1 → Id ℕ n0 n1)"
   ￫ error[E0510]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "echo ([ .head ⤇ 0 | .tail ↦ zeros ] : Stream ℕ)"
   ￫ error[E0508]
   ￭ command-line exec string
  ...
  [1]
  $ narya -parametric errors.ny -e "echo x y {\` unterminated block comment"
   ￫ error[E0200]
   ￭ command-line exec string
